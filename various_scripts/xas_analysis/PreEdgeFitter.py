...
data = ReadSingleXANESnor('4nm_References.nor', skip = 11)
    
#%% Set up a dataframe which will house the results
FitResults = pd.DataFrame(columns = ['Variable'])
FitResults['Variable'] = ['FWHM', 'A1 Area', 'A2 Area', 'A2+3 Area', 'A3 Area', 'B Area', 'C Area', 'A1 E0', 'A2 E0', 'A2+3 E0', 'A3 E0', 'B E0', 'C E0']
...
def pseudovoigt_area_meow50(E, a, w, e):
    return np.sum([a*(-0.626657*w*special.erf((0.707107/w)*(e-E))-0.25*w*np.arctan(2*(e-E)/w))], axis = 1)

def integrator(fxn, energy, dx = 0.001):
    return np.trapz(fxn, energy, dx = dx)
...
#%% PSEUDO-DATA ERROR ESTIMATION
nEval = 0
pseudo_space = np.linspace(4800, 5200, 10000)
pseudo_areas = np.array([])
while nEval < 50000:
    a = np.random.default_rng().normal(0.05, 0.005)
    w = np.random.default_rng().normal(1.35, 0.05)
    e = np.random.default_rng().normal(4975, 0.08)
    curve = pseudovoigt(pseudo_space, 0.5, a, w, e)
    area = np.trapz(curve, pseudo_space)
    pseudo_areas = np.append([pseudo_areas], [area])
    nEval += 1
pseudo_mean = np.average(pseudo_areas)
pseudo_error = np.std(pseudo_areas)/pseudo_mean
del (a, w, e, curve, area)
...
for label in data.columns[1:]:
    ...
    ax[0].set_ylabel("Normalized x\u03bc(E)", fontsize = 30)
    ...
    frame10.set_xlabel('Energy, eV', fontsize = 30)
    frame10.set_ylabel('$\Delta\mu$', fontsize = 30)
    ...
    # Peak Area Computations
    # for result0
    PeakAreas['totalABPeakArea_res0'] = np.sum([integrator(pseudovoigt(energy, 0.5, result0.params['a1'].value, result0.params['w1'].value, result0.params['e1'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result0.params['a2'].value, result0.params['w1'].value, result0.params['e2'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result0.params['a3'].value, result0.params['w1'].value, result0.params['e3'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result0.params['a4'].value, result0.params['w1'].value, result0.params['e4'].value), energy)])
    # PeakAreas['totalABPeakArea_res0_err'] = np.sum(np.sum(result0.params['a1'].stderr/result0.params['a1'].value, result0.params['w1'].stderr/result0.params['w1'].value, result0.params['e1'].stderr/result0.params['e1'].value),
    #                                 np.sum(result0.params['a2'].stderr/result0.params['a2'].value, result0.params['w1'].stderr/result0.params['w1'].value, result0.params['e2'].stderr/result0.params['e2'].value),
    #                                 np.sum(result0.params['a3'].stderr/result0.params['a3'].value, result0.params['w1'].stderr/result0.params['w1'].value, result0.params['e3'].stderr/result0.params['e3'].value),
    #                                 np.sum(result0.params['a4'].stderr/result0.params['a4'].value, result0.params['w1'].stderr/result0.params['w1'].value, result0.params['e4'].stderr/result0.params['e4'].value))
    PeakAreas['A1_res0'] = integrator(pseudovoigt(energy, 0.5, result0.params['a1'].value, result0.params['w1'].value, result0.params['e1'].value), energy)/PeakAreas['totalABPeakArea_res0']
    PeakAreas['A2_res0'] = integrator(pseudovoigt(energy, 0.5, result0.params['a2'].value, result0.params['w1'].value, result0.params['e2'].value), energy)/PeakAreas['totalABPeakArea_res0']
    PeakAreas['A23_res0'] = (PeakAreas['A1_res0']+PeakAreas['A2_res0'])/PeakAreas['totalABPeakArea_res0']
    PeakAreas['A3_res0'] = integrator(pseudovoigt(energy, 0.5, result0.params['a3'].value, result0.params['w1'].value, result0.params['e3'].value), energy)/PeakAreas['totalABPeakArea_res0']
    PeakAreas['B1_res0'] = integrator(pseudovoigt(energy, 0.5, result0.params['a4'].value, result0.params['w1'].value, result0.params['e4'].value), energy)/PeakAreas['totalABPeakArea_res0']
    PeakAreas['C1_res0'] = integrator(pseudovoigt(energy, 0.5, result0.params['a5'].value, result0.params['w1'].value, result0.params['e5'].value), energy)/PeakAreas['totalABPeakArea_res0']
    ...
    ax[1].set_ylabel("Normalized x\u03bc(E)", fontsize = 30)
    ...
    frame11.set_xlabel('Energy, eV', fontsize = 30)
    frame11.set_ylabel('$\Delta\mu$', fontsize = 30)
    ...
    # Peak Area Computations
    # for result1
    PeakAreas['totalABPeakArea_res1'] = np.sum([integrator(pseudovoigt(energy, 0.5, result1.params['a1'].value, result1.params['w1'].value, result1.params['e1'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result1.params['a2'].value, result1.params['w1'].value, result1.params['e2'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result1.params['a3'].value, result1.params['w1'].value, result1.params['e3'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result1.params['a4'].value, result1.params['w1'].value, result1.params['e4'].value), energy)])
    # PeakAreas['totalABPeakArea_res1_err'] = np.sum(np.sum(result1.params['a1'].stderr/result1.params['a1'].value, result1.params['w1'].stderr/result1.params['w1'].value, result1.params['e1'].stderr/result1.params['e1'].value),
    #                                 np.sum(result1.params['a2'].stderr/result1.params['a2'].value, result1.params['w1'].stderr/result1.params['w1'].value, result1.params['e2'].stderr/result1.params['e2'].value),
    #                                 np.sum(result1.params['a3'].stderr/result1.params['a3'].value, result1.params['w1'].stderr/result1.params['w1'].value, result1.params['e3'].stderr/result1.params['e3'].value),
    #                                 np.sum(result1.params['a4'].stderr/result1.params['a4'].value, result1.params['w1'].stderr/result1.params['w1'].value, result1.params['e4'].stderr/result1.params['e4'].value))
    PeakAreas['A1_res1'] = integrator(pseudovoigt(energy, 0.5, result1.params['a1'].value, result1.params['w1'].value, result1.params['e1'].value), energy)/PeakAreas['totalABPeakArea_res1']
    PeakAreas['A2_res1'] = integrator(pseudovoigt(energy, 0.5, result1.params['a2'].value, result1.params['w1'].value, result1.params['e2'].value), energy)/PeakAreas['totalABPeakArea_res1']
    PeakAreas['A23_res1'] = (PeakAreas['A1_res1']+PeakAreas['A2_res1'])/PeakAreas['totalABPeakArea_res1']
    PeakAreas['A3_res1'] = integrator(pseudovoigt(energy, 0.5, result1.params['a3'].value, result1.params['w1'].value, result1.params['e3'].value), energy)/PeakAreas['totalABPeakArea_res1']
    PeakAreas['B1_res1'] = integrator(pseudovoigt(energy, 0.5, result1.params['a4'].value, result1.params['w1'].value, result1.params['e4'].value), energy)/PeakAreas['totalABPeakArea_res1']
    PeakAreas['C1_res1'] = integrator(pseudovoigt(energy, 0.5, result1.params['a5'].value, result1.params['w1'].value, result1.params['e5'].value), energy)/PeakAreas['totalABPeakArea_res1']
    ...
    ax[2].set_ylabel("Normalized x\u03bc(E)", fontsize = 30)
    ...
    frame12.set_xlabel('Energy, eV', fontsize = 30)
    frame12.plot(energy,difference,color='magenta', label='Residuals')
    frame12.set_ylabel('$\Delta\mu$', fontsize = 30)
    ...
    # Peak Area Computations
    # for result2
    PeakAreas['totalABPeakArea_res2'] = np.sum([integrator(pseudovoigt(energy, 0.5, result2.params['a1'].value, result2.params['w1'].value, result2.params['e1'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result2.params['a2'].value, result2.params['w1'].value, result2.params['e2'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result2.params['a3'].value, result2.params['w1'].value, result2.params['e3'].value), energy),
                                                 integrator(pseudovoigt(energy, 0.5, result2.params['a4'].value, result2.params['w1'].value, result2.params['e4'].value), energy)])
    # PeakAreas['totalABPeakArea_res2_err'] = np.sum(np.sum(result2.params['a1'].stderr/result2.params['a1'].value, result2.params['w1'].stderr/result2.params['w1'].value, result2.params['e1'].stderr/result2.params['e1'].value),
    #                                 np.sum(result2.params['a2'].stderr/result2.params['a2'].value, result2.params['w1'].stderr/result2.params['w1'].value, result2.params['e2'].stderr/result2.params['e2'].value),
    #                                 np.sum(result2.params['a3'].stderr/result2.params['a3'].value, result2.params['w1'].stderr/result2.params['w1'].value, result2.params['e3'].stderr/result2.params['e3'].value),
    #                                 np.sum(result2.params['a4'].stderr/result2.params['a4'].value, result2.params['w1'].stderr/result2.params['w1'].value, result2.params['e4'].stderr/result2.params['e4'].value))
    PeakAreas['A1_res2'] = integrator(pseudovoigt(energy, 0.5, result2.params['a1'].value, result2.params['w1'].value, result2.params['e1'].value), energy)/PeakAreas['totalABPeakArea_res2']
    PeakAreas['A2_res2'] = integrator(pseudovoigt(energy, 0.5, result2.params['a2'].value, result2.params['w1'].value, result2.params['e2'].value), energy)/PeakAreas['totalABPeakArea_res2']
    PeakAreas['A23_res2'] = (PeakAreas['A1_res2']+PeakAreas['A2_res2'])/PeakAreas['totalABPeakArea_res2']
    PeakAreas['A3_res2'] = integrator(pseudovoigt(energy, 0.5, result2.params['a3'].value, result2.params['w1'].value, result2.params['e3'].value), energy)/PeakAreas['totalABPeakArea_res2']
    PeakAreas['B1_res2'] = integrator(pseudovoigt(energy, 0.5, result2.params['a4'].value, result2.params['w1'].value, result2.params['e4'].value), energy)/PeakAreas['totalABPeakArea_res2']
    PeakAreas['C1_res2'] = integrator(pseudovoigt(energy, 0.5, result2.params['a5'].value, result2.params['w1'].value, result2.params['e5'].value), energy)/PeakAreas['totalABPeakArea_res2']
    ...
    LastResult['Avg A1 Peak Share'] = np.average([PeakAreas['A1_res0'],PeakAreas['A1_res1'],PeakAreas['A1_res2']])
    LastResult['Avg A1 Peak Share Error'] = pseudo_error
    LastResult['Avg A2 Peak Share'] = np.average([PeakAreas['A2_res0'],PeakAreas['A2_res1'],PeakAreas['A2_res2']])
    LastResult['Avg A2 Peak Share Error'] = pseudo_error
    LastResult['Avg A2+3 Peak Share'] = np.average([PeakAreas['A23_res0'],PeakAreas['A23_res1'],PeakAreas['A23_res2']])
    LastResult['Avg A2+3 Peak Share Error'] = pseudo_error*2
    LastResult['Avg A3 Peak Share'] = np.average([PeakAreas['A3_res0'],PeakAreas['A3_res1'],PeakAreas['A3_res2']])
    LastResult['Avg A3 Peak Share Error'] = pseudo_error
    LastResult['Avg B Peak Share'] = np.average([PeakAreas['B1_res0'],PeakAreas['B1_res1'],PeakAreas['B1_res2']])
    LastResult['Avg B Peak Share Error'] = pseudo_error
    LastResult['Avg C Peak to Amp Sum'] = np.average([PeakAreas['C1_res0'],PeakAreas['C1_res1'],PeakAreas['C1_res2']])
    LastResult['Avg C Peak to Amp Sum Error'] = pseudo_error
...
ph_regionBorders['Variable'] = ['FWHM', 'A1 Area', 'A2 Area', 'A2+3 Area', 'A3 Area', 'B Area', 'C Area', 'A1 E0', 'A2 E0', 'A2+3 E0', 'A3 E0', 'B E0', 'C E0']
...
#%%
CombinedResults = pd.concat([RESULTS_cell2_v3, RESULTS_cell4_v1.iloc[:,3:]], axis = 1)

#%% BLOCK A3 - for PLOTTING FWHM SHARES in STANDARD MODEL
# Labels = ['Cell 4, OCV', 'Cell 4, 100 mA',  'Cell 4, OCV \npost 100 mA', 'Cell 4, 250 mA', 'Cell 4, OCV \npost 250 mA', 'Cell 4, 250 mA','Cell 4, OCV \npost 3 hr rest']
# Labels = ['4nm, dry', '4nm, H$_2$O',  '4nm, pH = 1', '4nm, pH = 7', '4nm, pH = 10']
Labels = ['Cell 2, OCV', 'Cell 4, 50 mA',  'Cell 2, 250 mA', 'Cell 2, OCV \npost 250 mA', 'Cell 2, 100 mA \npost 250 mA', 'Cell 4, 100 mA',  'Cell 4, OCV \npost 100 mA', 'Cell 4, 250 mA', 'Cell 4, OCV \npost 250 mA', 'Cell 4, 250 mA','Cell 4, OCV \npost 3 hr rest']
...
ax[0,0].set_prop_cycle('color', [plt.cm.gnuplot2(i) for i in np.linspace(0, 1, len(Labels)+1)])
for label in FitResults.columns[1:]:
    if str(label).endswith('value'):
...
ax[0,1].set_prop_cycle('color', [plt.cm.gnuplot2(i) for i in np.linspace(0, 1, len(Labels)+1)])
for label in FitResults.columns[1:]:
    if str(label).endswith('value'):
...
ax[0,2].set_prop_cycle('color', [plt.cm.gnuplot2(i) for i in np.linspace(0, 1, len(Labels)+1)])
for label in FitResults.columns[1:]:
    if str(label).endswith('value'):
...
ax[1,0].set_prop_cycle('color', [plt.cm.gnuplot2(i) for i in np.linspace(0, 1, len(Labels)+1)])
for label in FitResults.columns[1:]:
    if str(label).endswith('value'):
...
ax[1,1].set_prop_cycle('color', [plt.cm.gnuplot2(i) for i in np.linspace(0, 1, len(Labels)+1)])
for label in FitResults.columns[1:]:
    if str(label).endswith('value'):
...
ax[1,2].set_prop_cycle('color', [plt.cm.gnuplot2(i) for i in np.linspace(0, 1, len(Labels)+1)])
for label in FitResults.columns[1:]:
    if str(label).endswith('value'):
